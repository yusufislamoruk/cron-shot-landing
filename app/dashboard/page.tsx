...
export default function ConfigurationPage() {
    ...
    const { refetch } = useScheduledJobs();
    ...
    const handleSchedule = async () => {
        if (!url) {
            setFormError("Webpage URL is required.");
            return;
        }
    ...
    return (
        <div className="p-4 sm:p-8 max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-6 lg:gap-8">
            {/* Left Column: Form */}
            <div className="w-full lg:max-w-md xl:max-w-lg space-y-6">
                {/* Settings Block */}
                <div className="border border-[#1F2937] bg-[#12161F]/70 rounded-xl p-4 sm:p-6 shadow-sm">
            ...
            <div className="flex-1 flex flex-col gap-4">
                ...
                <div className="flex justify-end gap-3">
                    ...
                    >
                        ...
                        {formLoading ? "Capturing..." : "Capture"}
                    </button>
                </div>

                {/* Output Display */}
                <div className="relative flex-1 min-h-[300px] sm:min-h-[500px] bg-[#1a202c]/50 rounded-2xl border border-[#1F2937] flex flex-col items-center justify-center overflow-hidden shadow-inner p-4">
                    {/* Output Badge */}
